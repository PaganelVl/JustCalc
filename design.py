...
"        border-radius: 10px;")
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.btn_module.sizePolicy().hasHeightForWidth())
        self.btn_module.setSizePolicy(sizePolicy)
        self.btn_module.setCursor(QtGui.QCursor(QtCore.Qt.CursorShape.PointingHandCursor))
        self.btn_module.setObjectName("btn_module")
        self.gridLayout.addWidget(self.btn_module, 2, 1, 1, 1)
        ...
        self.btn_onediv = QtWidgets.QPushButton(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.btn_onediv.sizePolicy().hasHeightForWidth())
        self.btn_onediv.setSizePolicy(sizePolicy)
        self.btn_onediv.setCursor(QtGui.QCursor(QtCore.Qt.CursorShape.PointingHandCursor))
        self.btn_onediv.setObjectName("btn_onediv")
        self.gridLayout.addWidget(self.btn_onediv, 2, 0, 1, 1)
        ...
        self.btn_C.setCursor(QtGui.QCursor(QtCore.Qt.CursorShape.PointingHandCursor))
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("img/outline_backspace_black_36dp.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.btn_backspace.setIcon(icon1)
        self.btn_backspace.setIconSize(QtCore.QSize(36, 36))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_module.setText(_translate("MainWindow", "|x|"))
        ...
        self.btn_onediv.setText(_translate("MainWindow", "1/x"))
        self.btn_C.setText(_translate("MainWindow", "C"))
        self.btn_C.setShortcut(_translate("MainWindow", "Ins"))
